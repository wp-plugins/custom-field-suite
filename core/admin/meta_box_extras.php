...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align:top">
            ...
            <div><?php _e('Please install Gravity Forms to use this feature.', 'cfs'); ?> (<a href="https://www.e-junkie.com/ecom/gb.php?cl=54585&c=ib&aff=198410" target="_blank">URL</a>)</div>
        <?php endif; ?>
        </td>
    </tr>
</table>
